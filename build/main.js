(function () {
    ...
    ***************************************************************************** */
            ...
            return __generator(this, function (_e) {
                switch (_e.label) {
                    ...
                    case 2:
                        // Create the page and update the block like this so it looks instant
                        _e.sent();
                        return [4 /*yield*/, window.roamAlphaAPI.q("[:find ?uid :where [?e :node/title \"" + blockStr + "\"] [?e :block/uid ?uid]]")[0][0]];
                    case 3:
                        newPageUid = _e.sent();
                    ...
                    case 8:
                        ...
                        link = backlinks_1[_d];
                        newStr = link.string.replaceAll("((" + block.uid + "))", "[[" + block.string + "]]");
                        return [4 /*yield*/, window.roamAlphaAPI.data.block.update({
                                block: {
                                    uid: link.uid,
                                    string: newStr,
            ...
            return __generator(this, function (_e) {
                switch (_e.label) {
                    ...
                    case 7:
                        ...
                        link = backlinks_2[_d];
                        newStr = link.string.replaceAll("[[" + page.title + "]]", "((" + newBlockUid + "))");
                        return [4 /*yield*/, window.roamAlphaAPI.data.block.update({
                                block: {
                                    uid: link.uid,
                                    string: newStr,
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                ...
                document.addEventListener('keydown', function (e) { return __awaiter(_this, void 0, void 0, function () {
                    var currentBlockUid, pageUid, currentBlockUid, DAILY_NOTE_UID_REGEX;
                    var _a, _b, _c, _d, _e;
                    return __generator(this, function (_f) {
                        switch (_f.label) {
                            case 0:
                                if (!(e.ctrlKey && e.shiftKey && e.code === 'KeyW')) return [3 /*break*/, 2];
                                e.preventDefault();
                                return [4 /*yield*/, ((_a = window.roamAlphaAPI.ui.getFocusedBlock()) === null || _a === void 0 ? void 0 : _a['block-uid'])];
                            case 1:
                                currentBlockUid = _f.sent();
                                convertBlockToPage(currentBlockUid);
                                return [3 /*break*/, 8];
                            case 2:
                                if (!(e.ctrlKey && e.shiftKey && e.code === 'KeyQ')) return [3 /*break*/, 8];
                                pageUid = '';
                                return [4 /*yield*/, ((_b = window.roamAlphaAPI.ui.getFocusedBlock()) === null || _b === void 0 ? void 0 : _b['block-uid'])];
                            case 3:
                                currentBlockUid = _f.sent();
                                if (!currentBlockUid) return [3 /*break*/, 5];
                                return [4 /*yield*/, ((_d = (_c = window.roamAlphaAPI.q("[:find ?uid :in $ ?block-uid :where [?b :block/uid ?block-uid] [?b :block/page ?p] [?p :block/uid ?uid]]", currentBlockUid)) === null || _c === void 0 ? void 0 : _c[0]) === null || _d === void 0 ? void 0 : _d[0])];
                            case 4:
                                pageUid = _f.sent();
                                return [3 /*break*/, 7];
                            case 5: return [4 /*yield*/, window.roamAlphaAPI.ui.mainWindow.getOpenPageOrBlockUid()];
                            case 6:
                            ...
                            case 7:
                                ...
                                if (!pageUid || ((_e = pageUid.match(DAILY_NOTE_UID_REGEX)) === null || _e === void 0 ? void 0 : _e.length))
                                    return [2 /*return*/];
    ...
    var archivedNotesAttribute = archivedNotes + "::";
    ...
    function getOrCreateArchivedNotesAttribute() {
        var _a, _b, _c, _d;
        return __awaiter(this, void 0, void 0, function () {
            var todayDate, todayUid, archivedNotesAttributeUid, dnpPageExists, todayDateTitle;
            return __generator(this, function (_e) {
                switch (_e.label) {
                    case 0:
                        todayDate = new Date();
                    ...
                    case 1:
                        ...
                        if (!!archivedNotesAttributeUid) return [3 /*break*/, 7];
                        return [4 /*yield*/, ((_d = (_c = window.roamAlphaAPI.q("\n    [:find ?e :where [?e :block/uid \"10-10-21\"]]\n    ")) === null || _c === void 0 ? void 0 : _c[0]) === null || _d === void 0 ? void 0 : _d[0])];
                    case 2:
                        dnpPageExists = _e.sent();
                        if (!!dnpPageExists) return [3 /*break*/, 4];
                    ...
                    case 6:
                        _e.sent();
                        _e.label = 7;
                    case 7: return [2 /*return*/, archivedNotesAttributeUid];
                }
            });
        });
    }
